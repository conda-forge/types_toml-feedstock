...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/types_toml-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13038&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/types_toml-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `types_toml` can be installed with:

```
conda install types_toml
```

It is possible to list all of the versions of `types_toml` available on your platform with:
